...
def entities():
    return _rows(
        "SELECT slug, type, subtype, name, priority, status, hours_per_week, local_folder, file_path"
...
def tree():
    ...
    ents = _rows("SELECT slug, type, subtype, name, priority, local_folder FROM entities")
