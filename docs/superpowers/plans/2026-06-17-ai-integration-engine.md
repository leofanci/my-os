# myOS AI Integration Engine — Implementation Plan
...
- **Repo:** `/path/to/myOS` (branch: main). Work on a feature branch.
...
RAIL = (
    "You operate a myOS whose source of truth is authored files. "
