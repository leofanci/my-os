---
name: portfolio-sync
description: Cross-entity coordination for this week — align profiles with launches, fix sequencing, surface blocking dependencies. Use for "what needs syncing", "are profiles aligned with launches", or "what should happen before what". Not portfolio status or priorities — use weekly-review for that.
---

# Portfolio Sync

## When to use this (not weekly-review)
- **portfolio-sync**: coordination between entities — content ramp vs launch, conflicting messages across profiles, build-before-launch sequencing, max 5 cross-portfolio actions.
- **weekly-review**: single-portfolio health check — per-project stage/momentum, flags, and the week's top 3 priorities.
